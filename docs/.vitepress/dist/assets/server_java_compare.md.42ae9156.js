import{_ as s,c as n,o as a,b as l}from"./app.0be6fbf7.js";const i=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"server/java/compare.md","lastUpdated":1673183115000}'),p={name:"server/java/compare.md"},o=l(`<div class="language-tex"><button title="Copy Code" class="copy"></button><span class="lang">tex</span><pre><code><span class="line"><span style="color:#A6ACCD;">StopWatch &#39;List Get&#39;: running time (millis) = 5439</span></span>
